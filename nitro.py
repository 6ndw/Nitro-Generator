...
def sendnitro(nitro,webhook_url):
    ...
    embed.set_footer(text='Made By TWISTX7#9122')
...
def TWISTX7():
    os.system("cls && title NITRO-GEN BY TWISTX7#9122")
    generated = []
    valid = []
    invalid = []
    print(fire(f"""
            ...
            try:
                ...
                for x in range(amount):
                    ...
                    if r.status_code == 200:
                        ...
                        valid.append(nitro)
                        generated.append(nitro)
                        ctypes.windll.kernel32.SetConsoleTitleW("NITRO-GEN BY TWISTX#9122 | Valid -> " + str(len(valid)) + " | Invalid -> " + str(len(invalid)))
                    elif r.status_code == 429:
                        print(f"{Fore.YELLOW}Too Many Requests |{Fore.RESET} {nitro} | {r.status_code}")
                        generated.append(nitro)
                    else:
